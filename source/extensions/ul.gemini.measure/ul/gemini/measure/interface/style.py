...
STYLE_BUTTON_RESET = {
    ...
    "Rectangle::reset_valid": {
        "color": 0xFFFFFFFF,
        "background_color": 0xFFA07D4F,
        "border_radius": 2
    },
...
STYLE_COLLAPSABLE_FRAME = {
    ...
    "ComboBox": {"color": _CLR_LABEL, "background_color": 0xFF23211F, "secondary_color": 0xFF23211F, "border_radius": 2},
...
STYLE_COMBO_BOX_ALT = {
    "ComboBox": {"color": _CLR_LABEL, "background_color": 0xFF343432, "secondary_color": 0xFF343432, "border_radius": 2},
...
STYLE_RADIO_BUTTON = {
    ...
    "RadioButton.Image": {
        "image_url": __get_icon("radio_off")
    },
    "RadioButton.Image:checked": {
        "image_url": __get_icon("radio_on")
    }
}
...
STYLE_DISPLAY_PANEL = {**STYLE_COLLAPSABLE_FRAME, **{
    "VStack::container": {"margin": 8},
    "ComboBox": {"color": _CLR_LABEL, "background_color": 0xFF23211F, "secondary_color": 0xFF23211F, "border_radius": 2},
    "ComboBox:disabled": {"color": _CLR_DISABLED}
}}