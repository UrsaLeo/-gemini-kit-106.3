...
from ..common import SETTINGS_MEASURE_ENABLE_HOTKEYS
...
class Hotkey:
    ...
    def register(self, extension_name: str, action_name: str, action_reg, hotkey_reg, display_name: str = ""):
        ...
        self._kit_hotkey = hotkey_reg.register_hotkey(extension_name, self.key, extension_name, action_name, filter=filter)
