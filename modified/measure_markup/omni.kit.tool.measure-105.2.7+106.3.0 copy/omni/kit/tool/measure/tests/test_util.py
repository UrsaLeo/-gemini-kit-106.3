...
class TestMeasureBase(OmniUiTest):
    ...
    def create_test_light(self):
        ...
        cmd.execute("CreatePrim", prim_type="DistantLight", attributes={UsdLux.Tokens.inputsAngle: 1.0, UsdLux.Tokens.inputsIntensity: 3000})
    ...
    async def finalize_test(self, golden_img_name: str, threshold=None):
        await super().finalize_test(
            ...
            golden_img_name=golden_img_name + ".png"
        )
