...
from omni.kit.usd.layers import get_layers, Layers
...
class ReferenceManager:
    def __singleton_init__(self):
        ...
        # Sidecar
        try:
            from omni.usd_presenter.sidecar import register_data, SideCarData
            self.__sidecar: SideCarData = register_data("Annotation")
        except ImportError:
            self.__sidecar = None
