...
from ..common import EXTENSION_NAME, MeasureMode
            ...
            with self.add_frame("Measure Settings"):
                with ui.VStack():
                    self.create_setting_widget_combo(
                        "Default Measure tool on Application Start",
                        SETTINGS_STARTUP_TOOL_PERSISTENT,
                        enum_list
                    )
