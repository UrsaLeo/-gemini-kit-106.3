...
class CameraManipModeWatcher:
    ...
    def __init__(self):
        ...
        self._camera_manip_mode_sub_0 = self._settings.subscribe_to_node_change_events(f"{CameraManipModeWatcher.CAMERA_MANIP_MODE}/0", self._cam_manip_mode_changed)
        self._camera_manip_mode_sub_1 = self._settings.subscribe_to_node_change_events(f"{CameraManipModeWatcher.CAMERA_MANIP_MODE}/1", self._cam_manip_mode_changed)
